...
public class EnglishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        RequestManager manager = new RequestManager(EnglishActivity.this);
    ...
    private final OnFetchDataListener listener = new OnFetchDataListener() {
        ...
        public void onFetchData(APIResponse apiResponse, String message) {
            ...
            if (apiResponse == null){
                Toast.makeText(EnglishActivity.this, "No data found!!!", Toast.LENGTH_SHORT).show();
                return;
            }
        ...
        public void onError(String message) {
            progressDialog.dismiss();
            Toast.makeText(EnglishActivity.this, message, Toast.LENGTH_SHORT).show();
        }
    };
